...
function _fetchGridInfo() {
  _fetchGridInfo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(wordList) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 3;
          return fetch("https://wordsearch-api-production.up.railway.app/wordgrid?gridSize=".concat(GRID_SIZE, "&wordList=").concat(commaSeparatedWords));
        case 3:
